...
botoes = [
    {'operador': 'AC', 'fonte': colors.BLACK, 'fundo': colors.WHITE},
    {'operador': '~', 'fonte': colors.BLACK, 'fundo': colors.WHITE},
    {'operador': '%', 'fonte': colors.BLACK, 'fundo': colors.WHITE},
...
def main(page: ft.Page):
    ...
    res = ft.Text(value = '0', color = colors.WHITE, size=20)
    def select(e):
        value_at = res.value if res.value not in ('0', 'Error') else ''
